...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "Product names including Codex, Claude Code, Pi, Antigravity, OpenCode, Grok Build, GitHub, Vercel, GTK, and Ghostty are trademarks of their owners. ForkTTY is not affiliated with those providers unless stated otherwise.",
    ],
  },
];
