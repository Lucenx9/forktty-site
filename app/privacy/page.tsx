...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "Product names including Codex, Claude Code, Antigravity, OpenCode, Gemini CLI, GitHub, Vercel, GTK, and Ghostty are trademarks of their owners. ForkTTY is not affiliated with those providers unless stated otherwise.",
    ],
  },
];
