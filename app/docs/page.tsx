    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Task strategy methods cover read-only routing before agents choose team, loop, worktree, or harness roles.",
